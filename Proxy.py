...
class Ui_infoview(object):
    def setupUi(self, infoview):
        ...
        self.widget_left_info.setGeometry(QtCore.QRect(20, 30, 331, 431))
        self.widget_left_info.setStyleSheet("background-color: rgb(240, 255, 255);")
        self.widget_left_info.setObjectName("widget_left_info")
        self.label_user_name = QtWidgets.QLabel(self.widget_left_info)
        self.label_user_name.setGeometry(QtCore.QRect(10, 90, 121, 16))
        self.label_user_name.setObjectName("label_user_name")
        self.input_username = QtWidgets.QLineEdit(self.widget_left_info)
        self.input_username.setGeometry(QtCore.QRect(10, 110, 300, 30))
        self.input_username.setObjectName("input_username")
        self.label_uuid = QtWidgets.QLabel(self.widget_left_info)
        self.label_uuid.setGeometry(QtCore.QRect(10, 140, 41, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.text_UUID.setGeometry(QtCore.QRect(10, 160, 300, 50))
        self.text_UUID.setObjectName("text_UUID")
        self.label_pubkey = QtWidgets.QLabel(self.widget_left_info)
        self.label_pubkey.setGeometry(QtCore.QRect(10, 220, 30, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.text_infopublickey.setGeometry(QtCore.QRect(10, 240, 300, 50))
        self.text_infopublickey.setObjectName("text_infopublickey")
        self.btn_reset = QtWidgets.QPushButton(self.widget_left_info)
        self.btn_reset.setGeometry(QtCore.QRect(90, 320, 111, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.widget_right_info.setGeometry(QtCore.QRect(350, 30, 351, 431))
        ...
        self.label_version.setGeometry(QtCore.QRect(10, 90, 72, 15))
        self.label_version.setObjectName("label_version")
        self.text_version = QtWidgets.QTextBrowser(self.widget_right_info)
        self.text_version.setGeometry(QtCore.QRect(10, 110, 261, 31))
        self.text_version.setObjectName("text_version")
        self.label_author = QtWidgets.QLabel(self.widget_right_info)
        self.label_author.setGeometry(QtCore.QRect(10, 150, 72, 15))
        self.label_author.setObjectName("label_author")
        self.label_directory = QtWidgets.QLabel(self.widget_right_info)
        self.label_directory.setGeometry(QtCore.QRect(10, 220, 72, 15))
        self.label_directory.setObjectName("label_directory")
        self.label_otherInfo = QtWidgets.QLabel(self.widget_right_info)
        self.label_otherInfo.setGeometry(QtCore.QRect(10, 280, 72, 15))
        self.label_otherInfo.setObjectName("label_otherInfo")
        self.text_author = QtWidgets.QTextBrowser(self.widget_right_info)
        self.text_author.setGeometry(QtCore.QRect(10, 170, 261, 31))
        self.text_author.setObjectName("text_author")
        self.text_workdirectory = QtWidgets.QTextBrowser(self.widget_right_info)
        self.text_workdirectory.setGeometry(QtCore.QRect(10, 240, 261, 31))
        self.text_workdirectory.setObjectName("text_workdirectory")
        self.text_otherinfo = QtWidgets.QTextBrowser(self.widget_right_info)
        self.text_otherinfo.setGeometry(QtCore.QRect(10, 300, 261, 111))
        self.text_otherinfo.setObjectName("text_otherinfo")
        self.widget_top_info = QtWidgets.QWidget(self.information)
        self.widget_top_info.setGeometry(QtCore.QRect(20, 5, 681, 31))
        self.widget_top_info.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.widget_top_info.setObjectName("widget_top_info")
        self.btn_createUser = QtWidgets.QPushButton(self.widget_top_info)
        self.btn_createUser.setGeometry(QtCore.QRect(0, 0, 93, 28))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.btn_createUser.setFont(font)
        ...
        self.btn_createfile = QtWidgets.QPushButton(self.widget_center_2)
        self.btn_createfile.setGeometry(QtCore.QRect(120, 220, 21, 21))
        self.btn_createfile.setStyleSheet("border-color: rgb(240, 255, 255);")
        self.btn_createfile.setText("")
        self.btn_createfile.setIcon(icon1)
        self.btn_createfile.setIconSize(QtCore.QSize(20, 20))
        self.btn_createfile.setObjectName("btn_createfile")
        ...
        self.text_sign = QtWidgets.QTextBrowser(self.widget_right_2)
    ...
    def retranslateUi(self, infoview):
        ...
        self.label_user_name.setText(_translate("infoview", "<html><head/><body><p><span style=\" font-weight:600;\">用户名（可编辑）</span></p></body></html>"))
        ...
        self.label_otherInfo.setText(_translate("infoview", "其他信息："))
        self.btn_createUser.setText(_translate("infoview", "新建用户"))
